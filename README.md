...
- [Todos (cubit)](https://github.com/felangel/bloc/tree/master/examples/flutter_todos_cubit) - an example of how to create a Todos Application using the `cubit` (instead of `bloc`) and `flutter_bloc` packages based on [Flutter Todos Tutorial](https://bloclibrary.dev/#/fluttertodostutorial).

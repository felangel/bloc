...
Una librería de administración de estado predecible que ayuda a implementar el [patrón de diseño BLoC](https://www.flutteris.com/blog/en/reactive-programming-streams-blocc).
...
- [Contador](https://github.com/felangel/Bloc/tree/master/packages/bloc/example) - un ejemplo de cómo crear un `CounterBloc` (dart puro).

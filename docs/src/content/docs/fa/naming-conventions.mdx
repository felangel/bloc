...
:::note کلاس های رویداد پایه باید این نامگذاری را داشته باشند: `BlocSubject` +
`Event`. :::
...
:::note وضعیت‌های اولیه باید طبق این قرار داد عمل کنند: `BlocSubject` +
`Initial`. :::
...
:::note کلاس وضعیت پایه همیشه باید به این روش نام گذاری شوند: `BlocSubject` +
`State`. :::

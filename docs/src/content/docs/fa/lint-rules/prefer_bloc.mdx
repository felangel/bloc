...
تا برای حفظ یکپارچگی و سازگاری، در سراسر برنامه فقط از نمونه‌های `Bloc` استفاده کنند.

:::tip

برای آشنایی بیشتر با مزایای `Bloc` به
[Core Concepts](/bloc-concepts/#bloc-advantages) مراجعه کنید.
...
برای فعال کردن قانون `prefer_bloc`، آن را به فایل

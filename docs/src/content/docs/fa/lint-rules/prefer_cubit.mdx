...
برای حفظ یکپارچگی و سازگاری، در سراسر برنامه فقط از نمونه‌های `Cubit` استفاده کنند.

:::tip

برای آشنایی بیشتر با مزایای `Cubit` به
[Core Concepts](/bloc-concepts/#cubit-advantages) مراجعه کنید.

:::

## مثال‌ها
**اجتناب کنید**
از به‌کارگیری نمونه‌های `Bloc`
...
برای فعال کردن قانون `prefer_cubit`، آن را به فایل

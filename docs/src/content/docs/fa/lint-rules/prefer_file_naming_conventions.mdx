...
`bloc` و `cubit` را در فایل‌های Dart مربوط به خودشان تعریف کنید به‌جای آنکه آن‌ها
را به‌صورت درون‌خطی قرار دهید.

:::tip

در نظر داشته باشید از دستور `bloc new <component>` از
[package:bloc_tools](https://pub.dev/packages/bloc_tools) برای تولید سریع و یکنواخت
نمونه‌های جدید bloc/cubit استفاده کنید.

:::

## مثال‌ها
**ترجیح دهید**
 نمونه‌های bloc/cubit را در فایل‌های مربوطهٔ خودشان اعلام کنید.

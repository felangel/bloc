...
از استفاده از اکستنشن‌های `BuildContext` برای دسترسی به نمونه‌های `Bloc` یا `Cubit` خودداری کنید.
...
برای یکپارچگی و برای صراحت بیشتر، به‌جای استفاده از اکستنشن‌های `BuildContext` مستقیم از
روش‌های زیرین استفاده کنید. این رویکرد برای تست نیز مفید است، زیرا امکان موک کردن یک متد اکستنشن وجود ندارد.
...
از استفاده از اکستنشن‌های `BuildContext` برای تعامل با نمونه‌های `Bloc` یا `Cubit`
خودداری کنید.

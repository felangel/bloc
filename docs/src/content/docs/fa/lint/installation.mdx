...
پس از نصب ابزارهای خط فرمان bloc، می‌توانید لینتر bloc را با دستور
`bloc lint` اجرا کنید:
...
در صورت نیاز می‌توانید چند مجموعه قانون را با تعریف آن‌ها به‌صورت یک لیست
اضافه کنید:

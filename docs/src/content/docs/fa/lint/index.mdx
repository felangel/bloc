...
در صورت پیکربندی صحیح، لینتر bloc به آن import اشاره کرده و هشدار زیر را
تولید خواهد کرد:

<AvoidFlutterImportsWarningOutputSnippet />

در بخش‌های بعدی، نحوه نصب، پیکربندی و سفارشی‌سازی لینتر bloc را بررسی خواهیم
کرد تا بتوانید از تحلیل ایستا در کد خود بهره ببرید.
...
1. یک فایل `analysis_options.yaml` به ریشه پروژه اضافه کنید و قوانین پیشنهادی
   را قرار دهید

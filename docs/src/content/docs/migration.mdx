...
Refer to the [rationale for reintroducing the Bloc.observer and Bloc.transformer overrides](/migration#-reintroduce-blocobserver-and-bloctransformer-apis).
...
:::tip
For more information, [read the full proposal](https://github.com/felangel/bloc/issues/2526).
:::
...
:::tip
Check out [package:bloc_concurrency](https://pub.dev/packages/bloc_concurrency) for an opinionated set of custom event transformers
:::

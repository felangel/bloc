...
- [Equatable](/it/faqs#when-to-use-equatable) per prevenire aggiornamenti non
  necessari;
...
tramite lo stream todos. Vedi la sezione [flusso dati](#data-flow) per maggiori
informazioni.
...
sezione [flusso dati](#data-flow) per maggiori informazioni.

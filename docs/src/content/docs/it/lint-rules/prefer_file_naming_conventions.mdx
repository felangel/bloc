...
Per coerenza, facilità di manutenzione e separazione delle responsabilità preferisci
definire istanze bloc e cubit nei rispettivi file Dart invece di
inserirle inline.

:::tip

Considera di usare il comando `bloc new <component>` da
[package:bloc_tools](https://pub.dev/packages/bloc_tools) per generare rapidamente e
coerentemente nuove istanze bloc/cubit.

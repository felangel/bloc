...
description:
  Documentazione ufficiale per la libreria di "state management" bloc. Supporto per
  Dart, Flutter e AngularDart. Include esempi e tutorial.
banner:
  content: |
    ✨ Visita il
...
La nostra [guida introduttiva](/it/getting-started) contiene istruzioni passo-passo su
come iniziare a usare Bloc in pochi minuti.

</SplitCard>

<Card title="Fai un tour guidato" icon="star">
	Completa [i tutorial ufficiali](/it/tutorials/flutter-counter) per imparare le best
	practice e costruire una varietà di app diverse alimentate da Bloc.
</Card>

<Card title="Costruisci con Bloc" icon="laptop">
	Esplora app di esempio di alta qualità e completamente testate [come il counter,
	timer, lista infinita, meteo, todo e altro ancora!](https://github.com/felangel/bloc/tree/master/examples)
</Card>

...
Bloc এমনভাবে ডিজাইন করা হয়েছে যাতে এটি টেস্ট করা অত্যন্ত সহজ হয়। এই সেকশনে আমরা
একটি bloc কীভাবে ইউনিট টেস্ট করতে হয় তা দেখে নেব।

সহজতার জন্য, চলুন আমরা [Core Concepts](/bloc-concepts)-এ তৈরি করা `CounterBloc`-এর জন্য
টেস্ট লিখি।
...
এখন শুরু করি আমাদের `CounterBloc` টেস্টগুলোর জন্য ফাইল তৈরি করে।
ফাইলের নাম হবে `counter_bloc_test.dart` এবং আমরা সেখানে test প্যাকেজ ইমপোর্ট করব।
...
চলুন শুরু করি আমাদের `CounterBloc`-এর একটি ইনস্ট্যান্স তৈরি করে, যা সব টেস্টেই ব্যবহৃত হবে।
...
[bloc_test](https://pub.dev/packages/bloc_test) প্যাকেজ ব্যবহার করে আরও জটিল একটি
টেস্ট লিখি।
...
এতেই সব শেষ — টেস্টিং হওয়া উচিত খুবই সহজ, এবং কোড পরিবর্তন বা রিফ্যাক্টর করার সময়
আমাদের আত্মবিশ্বাসী লাগবে।

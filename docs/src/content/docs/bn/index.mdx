...
আমাদের [গেটিং স্টার্টেড গাইড](/getting-started)-এ ধাপে-ধাপে নির্দেশনা রয়েছে
...
<Card title="একটি গাইডেড ট্যুর নিন" icon="star">
	...
	সেরা প্র্যাকটিস শিখতে পারেন এবং Bloc-চালিত বিভিন্ন ধরনের অ্যাপ তৈরি করতে পারেন।
</Card>

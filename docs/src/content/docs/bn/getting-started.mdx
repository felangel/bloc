...
Bloc ব্যবহার শুরু করার জন্য আপনার মেশিনে
[Dart SDK](https://dart.dev/get-dart) ইনস্টল করা থাকতে হবে।

:::

## ইমপোর্টস

এখন যেহেতু আমরা Bloc সফলভাবে ইনস্টল করেছি, আমরা আমাদের `main.dart` তৈরি করতে পারি এবং
প্রয়োজনীয় `bloc` প্যাকেজ ইমপোর্ট করতে পারি।

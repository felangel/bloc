...
Bloc.observer এবং Bloc.transformer overrides পুনরায় চালু করার rationale-এর জন্য
দেখুন
[/migration#-reintroduce-blocobserver-and-bloctransformer-apis](/bn/migration#-reintroduce-blocobserver-and-bloctransformer-apis)।

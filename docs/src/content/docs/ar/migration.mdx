...
راجع
[الأسباب الكامنة وراء إعادة تقديم واجهات Bloc.observer و Bloc.transformer](/migration#-reintroduce-blocobserver-and-bloctransformer-apis).
...
final state = context.bloc<MyBloc>().state; return Text('$state'); }

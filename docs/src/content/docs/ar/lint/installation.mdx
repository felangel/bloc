...
لاستخدام المدقق من سطر الأوامر، قم بتثبيت حزمة
...
لتثبيت مجموعة قواعد التدقيق الموصى بها، قم بتثبيت حزمة
[`package:bloc_lint`](https://pub.dev/packages/bloc_lint) كاعتماد تطوير (dev
dependency) عبر الأمر التالي:

<InstallBlocLintSnippet />

بعد ذلك، أضف ملف `analysis_options.yaml` إلى الجذر الرئيسي لمشروعك مع مجموعة
القواعد الموصى بها:

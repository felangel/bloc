...
يحتوي [دليل البدء](/ar/getting-started) لدينا، على إرشادات خطوية حول كيفية بدء
استخدام بلوك في بضع دقائق قليلة
...
<ListCard title="تعلم" icon="open-book">
  ...
  <ListCard title="التكامل" icon="puzzle">
    ...
    - [ادوات المطورين](https://github.com/felangel/bloc/blob/master/packages/bloc_tools/README.md)
  </ListCard>
</CardGrid>

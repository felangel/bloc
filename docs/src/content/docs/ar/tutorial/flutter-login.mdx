...
- [BlocProvider](/flutter-bloc-concepts#blocprovider)، ويدجت Flutter يقوم بتوفير
  bloc للأطفال (العناصر الفرعية) الخاصة به.
...
- [RepositoryProvider](/flutter-bloc-concepts#repositoryprovider)، ويدجت Flutter
  يقوم بتوفير repository للأطفال الخاصة به.
- [BlocListener](/flutter-bloc-concepts#bloclistener)، ويدجت Flutter يقوم بتنفيذ
  كود المستمع استجابة لتغيرات الحالة في الـ bloc.
...
يُعد [`BlocObserver`](/bloc-concepts/#blocobserver-1) أداة ممتازة لتسجيل أحداث

...
- [BlocProvider](/ar/flutter-bloc-concepts#blocprovider)، ويدجيت في Flutter يوفر
  Bloc للأبناء.
- [BlocBuilder](/ar/flutter-bloc-concepts#blocbuilder)، ويدجيت في Flutter يتولى
  بناء الويدجيت استجابةً للحالات الجديدة.
- [BlocListener](/ar/flutter-bloc-concepts#bloclistener)، ويدجيت في Flutter ينفذ
  تأثيرات جانبية استجابةً لتغيرات الحالة.
- [RepositoryProvider](/ar/flutter-bloc-concepts#repositoryprovider)، ويدجيت في
  Flutter يوفر مستودع (repository) للأبناء.
- [Equatable](/ar/faqs/#متى-يجب-استخدام-equatable) لمنع عمليات إعادة البناء غير
  الضرورية.
- [MultiBlocListener](/ar/flutter-bloc-concepts#multibloclistener)، ويدجيت في
...
[تدفق البيانات](#تدفق-البيانات-data-flow#data-flow) لمزيد من التفاصيل.

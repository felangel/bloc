...
- [`BlocProvider`](/ar/flutter-bloc-concepts#blocprovider)، وهي ويدجت (Widget)
  من فلاتر توفر Bloc لأبنائها.
- [`BlocBuilder`](/ar/flutter-bloc-concepts#blocbuilder)، وهي ويدجت من فلاتر

...
title: بحث GitHub
description:
  دليل شامل حول كيفية بناء تطبيق بحث GitHub باستخدام Flutter و AngularDart مع
  bloc.
sidebar:
  order: 9
---
...
- [BlocProvider](/ar/flutter-bloc-concepts#blocprovider)، ويدجت Flutter التي
  توفر Bloc لأطفالها.
- [BlocBuilder](/ar/flutter-bloc-concepts#blocbuilder)، ويدجت Flutter التي تدير
  بناء الويدجت استجابة للحالات الجديدة.
- استخدام Cubit بدلاً من Bloc. [ما الفرق؟](/ar/bloc-concepts/#cubit-مقابل-bloc)
...
<RemoteCode
	url="https://raw.githubusercontent.com/felangel/bloc/master/examples/github_search/flutter_github_search/lib/search_bar.dart"
	title="flutter_github_search/lib/search_bar.dart"
/>

:::note

عندما يتغير النص، نقوم بإضافة حدث `TextChanged` إلى `GithubSearchBloc`.

:::

### جسم البحث

`_SearchBody` هو `StatelessWidget` مسؤول عن عرض نتائج البحث بناءً على حالة الـ
Bloc.

<RemoteCode
	url="https://raw.githubusercontent.com/felangel/bloc/master/examples/github_search/flutter_github_search/lib/search_body.dart"
	title="flutter_github_search/lib/search_body.dart"
/>

:::note

نحن نستخدم `BlocBuilder` لإعادة بناء الواجهة في كل مرة تتغير فيها حالة
`GithubSearchBloc`.
...
<RemoteCode
	url="https://raw.githubusercontent.com/felangel/bloc/master/examples/github_search/flutter_github_search/lib/search_results.dart"
	title="flutter_github_search/lib/search_results.dart"
/>

### عنصر نتيجة البحث

`_SearchResultItem` هو `StatelessWidget` يعرض تفاصيل مستودع واحد ويفتح الرابط
عند النقر.

<RemoteCode
	url="https://raw.githubusercontent.com/felangel/bloc/master/examples/github_search/flutter_github_search/lib/search_result_item.dart"
	title="flutter_github_search/lib/search_result_item.dart"
/>
...
تطبيق AngularDart GitHub Search سيعيد استخدام نفس منطق العمل من
`common_github_search`.

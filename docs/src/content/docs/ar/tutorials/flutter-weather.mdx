...
- [BlocProvider](/ar/flutter-bloc-concepts#blocprovider)، ويدجت Flutter التي
  توفر bloc لأبنائها.
- [BlocBuilder](/ar/flutter-bloc-concepts#blocbuilder)، ويدجت Flutter التي تتولى
...
- [RepositoryProvider](/ar/flutter-bloc-concepts#repositoryprovider)، ويدجت
  Flutter التي توفر repository لأبنائها.
- [BlocListener](/ar/flutter-bloc-concepts#bloclistener)، ويدجت Flutter التي
  تستدعي كود المستمع استجابةً لتغيرات الحالة في الـ bloc.
- [MultiBlocProvider](/ar/flutter-bloc-concepts#multiblocprovider)، ويدجت
  Flutter التي تجمع عدة BlocProvider في واحد.
- [BlocConsumer](/ar/flutter-bloc-concepts#blocconsumer)، ويدجت Flutter التي

...
<Card title="Mag-tour ng may patnubay" icon="star">
	Kumpletuhin [ang opisyal na pagtuturo](/es/tutorials/flutter-counter) para
	matutuhan ang tamang practices at gumawa ng iba't-ibang apps gamit si Bloc.
</Card>

<Card title="Gumawa gamit ang Bloc" icon="laptop">
	Siyasatin ang mga [halimbawang apps](https://github.com/felangel/bloc/tree/master/examples) 
  na may mataas na kalidad at puno ng test tulad ng counter, timer, infinite list, weather, 
  todo at iba pa!
</Card>

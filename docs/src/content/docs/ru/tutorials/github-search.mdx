...
title: Поиск GitHub
description:
  Подробное руководство по созданию приложения поиска GitHub во Flutter и AngularDart
  с использованием bloc.
sidebar:
  order: 9
---
...
В следующем руководстве мы собираемся создать приложение поиска GitHub во Flutter
и AngularDart, чтобы продемонстрировать, как мы можем делиться данными и слоями бизнес-логики

...
description: Подробное руководство по созданию приложения задач Flutter с использованием bloc.
sidebar:
  order: 6
---
...
В следующем руководстве мы собираемся создать приложение задач во Flutter, используя
библиотеку Bloc.

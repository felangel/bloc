...
стандартизировать использование только экземпляров `Bloc` во всем приложении
для согласованности.
...
Чтобы включить правило `prefer_bloc`, добавьте его в `analysis_options.yaml` в разделе
`bloc` > `rules`:

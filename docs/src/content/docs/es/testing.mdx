...
:::note Los grupos son para organizar pruebas individuales así como para crear
un contexto en el que se puede compartir un `setUp` y `tearDown` común en todas
...
:::note Podemos ejecutar todas nuestras pruebas con el comando `dart test`. :::

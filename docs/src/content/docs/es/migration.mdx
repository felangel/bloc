...
Consulta la [justificación para reintroducir las anulaciones de Bloc.observer y Bloc.transformer](/es/migration#-reintroduce-blocobserver-and-bloctransformer-apis).

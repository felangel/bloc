...
description:
  Огляд рекомендованих угод про іменування при використанні bloc.
---
...
При представленні стану у вигляді одного базового класу повинен використовуватися
enum з назвою `BlocSubject` + `Status` для представлення статусу стану:

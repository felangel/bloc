...
[Сховище](/uk/architecture#repository) є частиною бізнес-шару. Сховище залежить
від одного або кількох постачальників даних, що не мають бізнес-цінності, та
поєднує їхні публічні API у API, що надають бізнес-цінність. Крім того,

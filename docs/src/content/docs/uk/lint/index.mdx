...
Лінтинг — це процес статичного аналізу коду для виявлення потенційних помилок,
а також програмних і стилістичних проблем.
...
1. Додайте файл `analysis_options.yaml` у корінь вашого проєкту з рекомендованими
   правилами

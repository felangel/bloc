...
правила лінтера не обов'язково повинні узгоджуватися між собою. Наприклад,
деякі розробники можуть надавати перевагу використанню блоків (`prefer_bloc`),
тоді як інші можуть надавати перевагу використанню кубітів (`prefer_cubit`).
...
Для увімкнення окремих правил додайте `bloc:` до файлу `analysis_options.yaml` як
ключ верхнього рівня та `rules:` як ключ другого рівня. У наступних рядках
...
ігнорувати попередження або помилки, що відображаються у згенерованому коді, який
не був написаний вами та вашою командою. Так само, як і з офіційними правилами
лінтера Dart, ви можете використовувати опцію аналізатора `exclude:`, щоб
виключити файли зі статичного аналізу.

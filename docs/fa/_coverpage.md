<img src="https://raw.githubusercontent.com/felangel/bloc/master/docs/assets/bloc_logo_full.png" height="100" alt="Bloc" /><br/><small>v8.1.2</small>
...
> یک کتابخانه مدیریت وضعیت قابل پیش‌بینی برای Dart.

- ساده و سبک
- بسیار آزمایش پذیر
- برای دارت، فلاتر و انگولار دارت

<p class="buttons">
    <a href="#/migration">راهنمای مهاجرت</a>
    <a href="https://github.com/felangel/bloc/" target="_blank" rel="noopener">گیت هاب</a>
    <a href="#/gettingstarted">شروع کنید</a>    
</p>

<p align="center" style="margin-top: 2em; margin-bottom: 1em"><b>حمایت شده با 💖 توسط</b></p>

!(function (e, t) {
        ...
        N =
            ...
            (C.prototype.setComponent = function (e) {
                ...
                if (((this.component = e), this.shouldAutoInitialize())) {
                    ...
                    try {
                        for (
                            var r = p(this.instancesDeferred.entries()),
                                i = r.next();
                            !i.done;
                            i = r.next()
                        ) {
            ...
            (C.prototype.initialize = function (e) {
                ...
                try {
                    for (
                        var a = p(this.instancesDeferred.entries()),
                            s = a.next();
                        !s.done;
                        s = a.next()
                    ) {
                        var l = f(s.value, 2),
                            c = l[0],
                            u = l[1];
                        i === this.normalizeInstanceIdentifier(c) &&
                            u.resolve(o);
                    }
                } catch (e) {
                    t = { error: e };
            ...
            (C.prototype.onInit = function (e, t) {
                var n = this.normalizeInstanceIdentifier(t),
                    r =
                        null !== (t = this.onInitCallbacks.get(n)) &&
                        void 0 !== t
                            ? t
                            : new Set();
        ...
        var s = {},
            ...
            c = {
                ...
                initializeApp: function (e, t) {
                    ...
                    if (y(s, t))
                        throw V.create("duplicate-app", { appName: t });
                    n = new a(e, n, c);
                    return (s[t] = n);
                },
                app: u,
                ...
                "PUBLIC" === n.type &&
                    ((e = function (e) {
                        if (
                            ...
                            throw V.create("invalid-app-argument", {
                                appName: r,
                            });
                        return e[r]();
                    }),
    ...
    return (
        ee.registerVersion("firebase", "8.8.0", "app"),
        (ee.SDK_VERSION = "8.8.0"),
        ee
    );
});

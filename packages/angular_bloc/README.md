...
A Dart package that helps implement the [BLoC pattern](https://www.flutteris.com/blog/en/reactive-programming-streams-blocc) in [AngularDart](https://pub.dev/packages/angular). Built to work with [package:bloc](https://pub.dev/packages/bloc).

...
/// ```
/// {@endtemplate}
class BlocListenerWithTransition<B extends StateStreamable<S>, S>
    extends BlocListenerWithTransitionBase<B, S> {
  /// {@macro bloc_listener}
...
/// {@endtemplate}
abstract class BlocListenerWithTransitionBase<B extends StateStreamable<S>, S>
  ...
  /// The [BlocWidgetListenerWithTransition] which will be called on every `state` change.
  /// This [listener] should be used for any code which needs to execute
  /// in response to a `state` change.
  final BlocWidgetListenerWithTransition<S> listener;

  /// {@macro bloc_listener_listen_when}
  final BlocListenerWithTransitionCondition<S>? listenWhen;

  @override
  SingleChildState<BlocListenerWithTransitionBase<B, S>> createState() =>
      _BlocListenerWithTransitionBaseState<B, S>();
...
class _BlocListenerWithTransitionBaseState<B extends StateStreamable<S>, S>
    extends SingleChildState<BlocListenerWithTransitionBase<B, S>> {
  ...
  @override
  void didUpdateWidget(BlocListenerWithTransitionBase<B, S> oldWidget) {
